<template>
  <div class="container text-center mt-5">
    ...
    <header class="mb-4">
      ...
      <p class="lead">You are allowed to perform all operations.</p>
    </header>
        ...
        <div class="card-group">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text">Click to see all available managers.</p>
              <button class="btn btn-primary" @click="goToManagers">see</button>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    editCat(id){
      if(this.$route.path!=='/admin/edit/cat/'+id)
        this.$router.push('/admin/edit/cat/'+id)
    },   
    addPro(){
    ...
    editPro(id){
      if(this.$route.path!=='/admin/edit/pro/'+id)
        this.$router.push('/admin/edit/pro/'+id)
    },   
    async loadProducts() {
      try {
